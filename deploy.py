...
def run_cmd(cmd, check=True):
    """Выполняет команду, возвращает результат. Если check=True, при ошибке завершает скрипт."""
...
def main():
    ...
    if not status.stdout.strip():
        ...
        # Всё равно можно попробовать пуш (на случай, если локально нет изменений, но удалённые есть)
    else:
        # Формируем сообщение коммита с датой
