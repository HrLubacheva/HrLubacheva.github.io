// ============================================================
// 99_main.js – Главная инициализация: анимации, статистика, активное меню, вызов модулей
// ============================================================
(function () {
    'use strict';
    ...
    // Модалка для отправки материалов на email
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // 2. Переопределяем калькулятор и квиз с обёртками для анимаций
