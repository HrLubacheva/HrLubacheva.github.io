...
def build_page():
    ...
    floating_share = read_file(os.path.join(COMMON_DIR, "05_floating-share.html"))
    ...
    body_content = navbar + sections_html + footer + cookie + privacy + floating_share + materials_modal
